...
lat_resp_dat2_summary <- lat_resp_dat2 |> 
  distinct(sampleID, replicate, .keep_all = TRUE)
datasummary(region *(rate.output) ~  N + mean + MinMax + Range + Histogram, 
            data=lat_resp_dat2_summary)
datasummary(region * dev.temp * (rate.output) + (rate.output) ~  N + median + MinMax + Range + Histogram, 
            data=lat_resp_dat2_summary) 

lat_resp_dat2_summary |> 
...
rate.priors <- prior(normal(430, 25), class="Intercept") +  
...
model1.gamk4_resids <- createDHARMa(simulatedResponse = t(preds), 
                              observedResponse = lat_resp_dat2$rate.output2, 
                              fittedPredictedResponse = apply(preds, 2, mean), 
                              integerResponse = 'student')
...
```{r emmeans-pairwise}
model1.gamk4 |> emmeans(pairwise ~ region*dev.temp, type="response") |> regrid() |> pairs(by="dev.temp") |> summary(infer=TRUE)

model1.gamk4 |> emmeans(pairwise ~ region*dev.temp, type="response") |> regrid() |> pairs(by="region") |> confint()
...
```{r echo =TRUE}
pre.model1 <- readRDS("03.CTmax_resp_data_analsyis_files/pre.model1.RDS")
```
...
pre.model1 |> emmeans(pairwise ~ region*dev.temp, type="response") |> regrid() |> pairs(by="dev.temp") |> summary(infer=TRUE)

pre.model1 |> emmeans(pairwise ~ region*dev.temp, type="response") |> regrid() |> pairs(by="region") |> confint()
...
```{r echo=FALSE}
post.model1 <- readRDS("03.CTmax_resp_data_analsyis_files/post.model1.RDS")
```
...
low_28.raw <- ggplot(my.model, aes(x=temperature, y=rate.output)) + 
  geom_line() + 
  geom_vline(xintercept = my.seg$psi[1,2]) + 
  geom_vline(xintercept = my.seg$psi[2,2])+ 
  geom_vline(xintercept = my.seg$psi[3,2]) +  
  xlab("Temperature \u00B0C")+ 
  ylab(expression("Oxygen uptake " ~ (mgO[2]^ -1)))+
  scale_y_continuous(limits=c(0,2), breaks = seq(0,2, 0.2))+
  theme_classic()


low_28 <- ggplot(posterior_draws, aes(x=Temperature, y=.linpred, color="coral")) +
  geom_point(alpha=0.05, size=1) + 
  geom_smooth(data=as.data.frame(spline_fit$data), aes(x=x, y=y), color="coral", 
              size=3) + ylab(expression("Oxygen uptake " ~ (mgO[2]^ -1)))+ 
  xlab("") +
  scale_x_continuous(limits=c(30,38), breaks = seq(30,38, 2))+
  scale_y_continuous(limits=c(0,2), breaks = seq(0,2, 0.2))+
  #geom_vline(xintercept = my.seg$psi[1,2], alpha=0.2) + 
   geom_vline(xintercept = my.seg$psi[1,2], linewidth=1.25)+ 
  #geom_vline(xintercept = my.seg$psi[3,2], alpha=0.2)+ 
 ...
 #geom_vline(xintercept = my.seg$psi[2,1], color="blue") + 
  ...
  annotate("text", x=my.seg$psi[1,2]+1,y=1, label = paste0(round(my.seg$psi[1,2], 2)," \u00B0","C"), color="black") +
  theme_classic() + theme(legend.position = "none"); low_28
```
...
summary(bp.data) 
plot(bp.data) 
breakpoint.values=c(15,54,70,85); spline.data[breakpoint.values, c("x")] 
...
low_30.raw <- ggplot(my.model, aes(x=temperature, y=rate.output)) + 
  geom_line() + 
  geom_vline(xintercept = my.seg$psi[1,2]) + 
  geom_vline(xintercept = my.seg$psi[2,2])+ 
  geom_vline(xintercept = my.seg$psi[3,2]) +  
...
low_30 <- ggplot(posterior_draws, aes(x=Temperature, y=.linpred, color="red2")) +
  geom_point(alpha=0.05, size=1, color="red2") + 
  geom_smooth(data=as.data.frame(spline_fit$data), aes(x=x, y=y), color="red2", 
              size=3) + ylab(expression("Oxygen uptake " ~ (MgO[2]^ -1)))+ 
  xlab("") +
  scale_x_continuous(limits=c(30,38), breaks = seq(30,38, 2))+
  scale_y_continuous(limits=c(0,2), breaks = seq(0,2, 0.2))+
  geom_vline(xintercept = my.seg$psi[2,2], linewidth=1.25) + 
   #geom_vline(xintercept = my.seg$psi[2,2], alpha=0.2)+ 
  #geom_vline(xintercept = my.seg$psi[3,2], alpha=0.2)+ 
   #geom_vline(xintercept = my.seg$psi[1,1], color="blue") + 
 #geom_vline(xintercept = my.seg$psi[2,1], color="blue") + 
  #geom_vline(xintercept = my.seg$psi[3,1], color="blue") + 
  geom_line(data=my.model, aes(x=temperature, y=rate.output), color="black", size=2) + 
  annotate("text", x=my.seg$psi[2,2]+1,y=1, label = paste0(round(my.seg$psi[2,2], 2)," \u00B0","C"), color="black") +
  theme_classic() + theme(legend.position = "none"); low_30
```
...
low_31.raw <- ggplot(my.model, aes(x=temperature, y=rate.output)) + 
  geom_line() + 
  geom_vline(xintercept = my.seg$psi[1,2]) + 
  geom_vline(xintercept = my.seg$psi[2,2])+ 
  geom_vline(xintercept = my.seg$psi[3,2]) +  
...
low_31 <- ggplot(posterior_draws, aes(x=Temperature, y=.linpred, color="firebrick4")) +
  geom_point(alpha=0.05, size=1, color="firebrick4") + 
  geom_smooth(data=as.data.frame(spline_fit$data), aes(x=x, y=y), color="firebrick4", 
              size=3) + ylab(expression("Oxygen uptake " ~ (MgO[2]^ -1)))+ 
  xlab(paste0("Temperature"," \u00B0","C")) +
  scale_x_continuous(limits=c(30,38), breaks = seq(30,38, 2))+
  scale_y_continuous(limits=c(0,2), breaks = seq(0,2, 0.2))+
  geom_vline(xintercept = my.seg$psi[1,2], linewidth=1.25) + 
   #geom_vline(xintercept = my.seg$psi[2,2], alpha=0.2)+ 
 ...
 #geom_vline(xintercept = my.seg$psi[2,1], color="blue") + 
  ...
  geom_line(data=my.model, aes(x=temperature, y=rate.output), color="black", size=2) + 
  annotate("text", x=my.seg$psi[1,2]+1,y=1, label = paste0(round(my.seg$psi[1,2], 2)," \u00B0","C"), color="black") +
  theme_classic() + theme(legend.position = "none"); low_31
```
...
high_28.raw <- ggplot(my.model, aes(x=temperature, y=rate.output)) + 
  geom_line() + 
  geom_vline(xintercept = my.seg$psi[1,2]) + 
  geom_vline(xintercept = my.seg$psi[2,2])+ 
  geom_vline(xintercept = my.seg$psi[3,2]) +  
...
high_28 <- ggplot(posterior_draws, aes(x=Temperature, y=.linpred, color="lightskyblue")) +
  geom_point(alpha=0.05, size=1, color="lightskyblue") + 
  geom_smooth(data=as.data.frame(spline_fit$data), aes(x=x, y=y), color="lightskyblue", 
              size=3) + ylab(expression("Oxygen uptake " ~ (MgO[2]^ -1)))+ 
  xlab("") +
  scale_x_continuous(limits=c(30,38), breaks = seq(30,38, 2))+
  scale_y_continuous(limits=c(0,2), breaks = seq(0,2, 0.2))+
 ...
 #geom_vline(xintercept = my.seg$psi[2,1], color="blue") + 
  ...
  geom_line(data=my.model, aes(x=temperature, y=rate.output), color="black", size=2) + 
  annotate("text", x=my.seg$psi[1,2]+1,y=1, label = paste0(round(my.seg$psi[1,2], 2)," \u00B0","C"), color="black") +
  theme_classic() + theme(legend.position = "none"); high_28
```
...
high_30.raw <- ggplot(my.model, aes(x=temperature, y=rate.output)) + 
  geom_line() + 
  geom_vline(xintercept = my.seg$psi[1,2]) + 
  geom_vline(xintercept = my.seg$psi[2,2])+ 
  geom_vline(xintercept = my.seg$psi[3,2]) +  
...
high_30 <- ggplot(posterior_draws, aes(x=Temperature, y=.linpred, color="dodgerblue2")) +
  geom_point(alpha=0.05, size=1, color="dodgerblue2") + 
  geom_smooth(data=as.data.frame(spline_fit$data), aes(x=x, y=y), color="dodgerblue2", 
              size=3) + ylab(expression("Oxygen uptake " ~ (MgO[2]^ -1)))+ 
  xlab("") +
  scale_x_continuous(limits=c(30,38), breaks = seq(30,38, 2))+
  scale_y_continuous(limits=c(0,2), breaks = seq(0,2, 0.2))+
 ...
 #geom_vline(xintercept = my.seg$psi[2,1], color="blue") + 
  ...
  geom_line(data=my.model, aes(x=temperature, y=rate.output), color="black", size=2) + 
  annotate("text", x=my.seg$psi[2,2]+1,y=1, label = paste0(round(my.seg$psi[2,2], 2)," \u00B0","C"), color="black") +
  theme_classic() + theme(legend.position = "none"); high_30
```
...
high_31.raw <- ggplot(my.model, aes(x=temperature, y=rate.output)) + 
  geom_line() + 
  geom_vline(xintercept = my.seg$psi[1,2]) + 
  geom_vline(xintercept = my.seg$psi[2,2])+ 
  geom_vline(xintercept = my.seg$psi[3,2]) +  
...
high_31 <- ggplot(posterior_draws, aes(x=Temperature, y=.linpred, color="dodgerblue4")) +
  geom_point(alpha=0.05, size=1, color="dodgerblue4") + 
  geom_smooth(data=as.data.frame(spline_fit$data), aes(x=x, y=y), color="dodgerblue4", 
              size=3) + 
  ylab(expression("Oxygen uptake " ~ (MgO[2]^ -1)))+ 
  xlab(paste0("Temperature"," \u00B0","C")) +
  scale_x_continuous(limits=c(30,38), breaks = seq(30,38, 2))+
 ...
 #geom_vline(xintercept = my.seg$psi[2,1], color="blue") + 
  ...
  geom_line(data=my.model, aes(x=temperature, y=rate.output), color="black", size=2) + 
  annotate("text", x=my.seg$psi[1,2]+1,y=1, label = paste0(round(my.seg$psi[1,2], 2)," \u00B0","C"), color="black") +
  theme_classic() + theme(legend.position = "none"); high_31
```
...
figure4 <- (low_28 | high_28) /  (low_30 | high_30) / (low_31 | high_31) + 
  plot_annotation(tag_levels ="A") & 
  scale_y_continuous(name =expression("Oxygen uptake " ~ (mgO[2]^ -1)), 
                     limits=c(0.2,1.6), breaks = seq(0.2,1.6, 0.2)) & 
  theme(axis.text =element_text(size=14), 
        axis.title = element_text(size=14)) ; figure4
```

```{r}
#ggsave(file="./figures/figure4.svg",  plot=figure4 , width=10, height=14, units = "in", dpi=300) 
#ggsave(file="./figures/figure4.pdf",  plot=figure4 , width=8, height=12, units = "in", dpi=1200)
```

```{r}
Sfigure4 <- (low_28.raw | high_28.raw) /  (low_30.raw | high_30.raw) / (low_31.raw | high_31.raw) + 
  plot_annotation(tag_levels ="A") & 
  scale_y_continuous(name =expression("Oxygen uptake " ~ (mgO[2]^ -1)), 
                     limits=c(0.2,1.6), breaks = seq(0.2,1.6, 0.2)) & 
  theme(axis.text =element_text(size=14), 
        axis.title = element_text(size=14)) ; Sfigure4
```

```{r}
#ggsave(file="./figures/Sfigure4.svg",  plot=Sfigure4 , width=10, height=14, units = "in", dpi=300) 
#ggsave(file="./figures/Sfigure4.pdf",  plot=Sfigure4 , width=8, height=12, units = "in", dpi=1200)
```