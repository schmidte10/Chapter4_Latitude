...
FISH_ID = "120.CPRE.336.28,5.1"
mass = 0.0010624 #in kilograms 
chamber = "ch4" 
salinity = 36 
chamber_vol = 0.06891
system1 = "ASUS" 
...
firesting <- read_delim("C:/Users/jc527762/OneDrive - James Cook University/PhD dissertation/Data/2023/2023_CTmaxResp/ASUS/Experiment_ 07 July 2023 11 52AM/Oxygen data raw/firesting.txt", 
                             delim = "\t", escape_double = FALSE, 
                             col_types = cols(`...2` = col_time(format = "%H:%M:%S")), 
                             trim_ws = TRUE, skip = 18) 
firesting <- firesting[-1,]

pre_bg_dir = "C:/Users/jc527762/OneDrive - James Cook University/PhD dissertation/Data/2023/2023_CTmaxResp/ASUS/Experiment_ 07 July 2023 10 40AM/All slopes" 
post_bg_dir = "C:/Users/jc527762/OneDrive - James Cook University/PhD dissertation/Data/2023/2023_CTmaxResp/ASUS/Experiment_ 07 July 2023 07 38PM/All slopes"
...
RMR.raw <-  apoly_cr.int_adj$summary |> 
  ...
  mutate(Temperature = as.numeric(Temperature) + 0.15)
```
