...
## Basic model
```{r}
form <- bf(cMASS ~ REGION + cMALE_MASS + HATCHLINGS, 
              family=gaussian())
get_prior(form, data = hmass2)
priors <- prior(normal(0.004, 0.001), class="INtercept") +
  prior(normal(0, 0.001), class ="b") +
  prior(student_t(3, 0, 0.001), class = "sigma")
```
