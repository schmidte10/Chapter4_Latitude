...
#### Prior fits 
```{r}
#cmp <- list("Prior" = avg_comparisons(model1))
```
...
mcmc_plot(model1.geo, type='combo')
mcmc_plot(model1.geo, type='trace') 
mcmc_plot(model1.geo, type='dens_overlay') 
mcmc_plot(model1.geo, type='acf_bar')
mcmc_plot(model1.geo, type='rhat_hist')
mcmc_plot(model1.geo, type='neff_hist') 
```
