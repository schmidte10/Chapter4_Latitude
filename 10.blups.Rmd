...
# Model1.1
```{r model1.1}
model1.1 <- lmer(LENGTH ~ as.numeric(DEV_TEMP) + scale(DENSITY, scale=TRUE, center=TRUE)  + (1 |POPULATION), 
                 REML=FALSE,
                 data=growth3)   
...
#Model1.2
```{r model1.2}
model1.2 <- lmer(LENGTH ~ poly(as.numeric(DEV_TEMP), 2, raw = TRUE)+ scale(DENSITY, scale=TRUE, center=TRUE)  + (1 |POPULATION), 
                 REML=FALSE,
                 data=growth3)  
...
# Model1.3
```{r model1.3}
model1.3 <- lmer(LENGTH ~ poly(as.numeric(DEV_TEMP), 2, raw = TRUE) + scale(DENSITY, scale=TRUE, center=TRUE)  + (1 |POPULATION) + (1 |FEMALE), 
                 REML=FALSE,
                 data=growth3) 
...
# Model1.4 
```{r}
model1.4 <- lmer(LENGTH ~ poly(as.numeric(DEV_TEMP), 2, raw = TRUE)+ scale(DENSITY, scale=TRUE, center=TRUE)  + (1 |POPULATION) + (1+DEV_TEMP|FEMALE), 
                 REML=FALSE,
                 data=growth3) 
...
# Model1.5 
```{r warning=FALSE}
model1.5 <- lmer(LENGTH ~ poly(as.numeric(DEV_TEMP), 2, raw = TRUE) + scale(DENSITY, scale=TRUE, center=TRUE)  + (1 |POPULATION) + (1+DEV_TEMP + I(DEV_TEMP^2)|FEMALE), 
                 REML=FALSE,
                 data=growth3) 
